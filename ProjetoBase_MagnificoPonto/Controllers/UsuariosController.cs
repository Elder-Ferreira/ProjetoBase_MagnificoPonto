...
namespace ProjetoBase_MagnificoPonto.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,CPF,Telefone")] UsuarioModel usuarioModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,CPF,Telefone")] UsuarioModel usuarioModel)
        {
